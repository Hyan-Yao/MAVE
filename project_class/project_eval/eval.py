...
INPUT_EXPECTED_CI_JSON = DEMO_BASE / "teacher_expected_ci_by_knowledge.json"

DEFAULT_OUTPUT_JSON = DEMO_BASE / "demo_icap_eval.json"
DEFAULT_OUTPUT_MD = DEMO_BASE / "demo_icap_eval.md"
